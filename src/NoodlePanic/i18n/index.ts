const zh = {
  title: '菌落封锁', subtitle: '下净化球，封住菌株', start: '开始净化', score: '净化点', best: '最高', combo: '连锁', time: '培养时间', noodle: '碰到菌株！', timeup: '培养成功', replay: '再做一次', hint: '点净化球 · 别碰菌株', newBest: '新纪录！', levelUp: '封锁加强！', muted: '声音已关闭', sound: '声音', leaderboard: '排行榜',
}
const en = {
