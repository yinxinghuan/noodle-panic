...
import { Crown, Gamepad2, Trophy, X } from 'lucide-react';
      ...
      <div className="lb-panel">
        ...
        <div className="lb-header">
          <div className="lb-header__left">
            <span className="lb-header__icon"><Crown size={28} aria-hidden="true" /></span>
            <div>
        ...
        <div className="lb-body">
          ...
          {!loading && !isInAigram && (
            ...
            <span className="lb-state__icon"><Trophy size={34} aria-hidden="true" /></span>
          ...
          {!loading && isInAigram && entries.length === 0 && (
            <div className="lb-state">
            <span className="lb-state__icon"><Gamepad2 size={34} aria-hidden="true" /></span>
